...
#Sound Stimulus
in_phase_snd = sound.Sound('10s_whiteNoiseBursts_In_Phase_250.wav')
out_phase_snd = sound.Sound('10s_whiteNoiseBursts_Out_Phase_250.wav')
...
#   trialfile = open("/Users/maxkails/Desktop/AudioVisMotionRatchetExp/TrialOrderLists_AudioVisMotionRatchet/AudioVisCircMotionRatchet_TrialOrderList"+subj[2]+".txt", 'r')
    trialfile = open("C:\Users\lab user\Desktop\AudioVisMotionRatchetExp\\TrialOrderLists_AudioVisMotionRatchet\\AudioVisCircMotionRatchet_TrialOrderList"+subj[2]+".txt", 'r') # For Windows
...
#file_log = "/Users/maxkails/Desktop/AudioVisMotionRatchetExp/data/"
...
if resume == 0:
    print "not resuming"
    log_file = open("C:\Users\lab user\Desktop\AudioVisMotionRatchetExp\data\AVMotion_subject%s.txt" % (subj), 'w') # subj, con, block) -- For Windows
#    log_file = open("/Users/maxkails/Desktop/AudioVisMotionRatchetExp/data/AVMotion_subject%s.txt" % (subj), 'w') # subj, con, block)
    ...
    log_file.write('In Phase Sound File: %s\n' % ('10s_whiteNoiseBursts_In_Phase_250.wav'))
    log_file.write('Out Phase Sound File: %s\n' % ('10s_whiteNoiseBursts_Out_Phase_250.wav'))
...
for trial in trialOrder:
    ...
    log_file = open("C:\Users\lab user\Desktop\AudioVisMotionRatchetExp\data\AVMotion_subject%s.txt" % (subj), 'a') #(subj, con, block) -- For Windows
#    log_file = open("/Users/maxkails/Desktop/AudioVisMotionRatchetExp/data/AVMotion_subject%s.txt" % (subj), 'a') # subj, con, block)
